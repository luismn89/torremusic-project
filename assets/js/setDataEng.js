...
const paragraphMediaEng = document.querySelector('#paragraph_eng.description');
...
if (!!firstQuoteTorreEng) {
  firstQuoteTorreEng.querySelector('em')?.innerHTML = `${DESCRIPCIONES_TORRE_ENG.primeraReferencia.texto}<br>`;
